...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('items', function (Blueprint $table) {
            ...
            $table->foreignId('category_id')->constrained()->onDelete('cascade'); //Cascade denotes that when a category is deleted, all items associated with it should be deleted as well.
            $table->timestamps();
        });
    }
