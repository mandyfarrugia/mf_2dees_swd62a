            ...
            <div class="row">
                <div class="col-xl-9 col-lg-10 mx-auto">
                    <div class="bg-faded rounded p-5">
                        ...
                        <p id="about_paragraph">I am Mandy Farrugia, aged <?= intval(date('Y', time() - strtotime('2001-12-05'))) - 1970 ?> (born 5 December 2001), massive foodie and music-head, and hailing from an island in the Mediterranean sea where the four seasons and privacy are a distant dream, and if you have not gotten the hint already, I have a penchant for Warhammer and gaming. When I am not reimaging assets and providing end-user support for a living or tinkering (pun-intended) with software development technologies, my notion of a personal heaven would be a comfortable gaming chair while enjoying Gears of War, Warhammer 40,000 Space Marine, Halo (Bungie Inc. > 343 Industries), Visage, Outlast, Red Dead Redemeption, and Dead Space... and last but not least, Turkish Döner kebab complemented by garlic &amp; yoghurt sauce and pita bread.</p>
                        <p class="mb-0"></p>
